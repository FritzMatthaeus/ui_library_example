...
class OutlinedActionCancelButton extends StatelessWidget {
  final ButtonSize size;
  final bool isDisabled;
  const OutlinedActionCancelButton({
    super.key,
  ...
  Widget build(BuildContext context) {
    return BaseOutlinedButton(
      ...
      size: size,
      style: context.myOutlinedButtonTheme.actionCancel,
      onPressed: () {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Outlined Action Cancel button pressed')),
        );
      },
      title: 'Cancel',
    );
